...
static struct pvs_table pvs_v1_lge_factory[NUM_PVS_REVS][NUM_SPEED_BINS][NUM_PVS] __initdata = {
	/* 8974v1 1.7GHz Parts */
	[0][0][0] = { acpu_freq_tbl_v1_pvs0_lge_factory, sizeof(acpu_freq_tbl_v1_pvs0_lge_factory) },
	[0][0][1] = { acpu_freq_tbl_v1_pvs1_lge_factory, sizeof(acpu_freq_tbl_v1_pvs1_lge_factory) },
	[0][0][2] = { acpu_freq_tbl_v1_pvs2_lge_factory, sizeof(acpu_freq_tbl_v1_pvs2_lge_factory) },
	[0][0][3] = { acpu_freq_tbl_v1_pvs3_lge_factory, sizeof(acpu_freq_tbl_v1_pvs3_lge_factory) },
	[0][0][4] = { acpu_freq_tbl_v1_pvs4_lge_factory, sizeof(acpu_freq_tbl_v1_pvs4_lge_factory) },
};

static struct pvs_table pvs_v2_lge_factory[NUM_PVS_REVS][NUM_SPEED_BINS][NUM_PVS] __initdata = {
	/* 8974v2 2.0GHz Parts */
	[0][0][0] = { acpu_freq_tbl_2g_pvs0_lge_factory, sizeof(acpu_freq_tbl_2g_pvs0_lge_factory) },
	[0][0][1] = { acpu_freq_tbl_2g_pvs1_lge_factory, sizeof(acpu_freq_tbl_2g_pvs1_lge_factory) },
	[0][0][2] = { acpu_freq_tbl_2g_pvs2_lge_factory, sizeof(acpu_freq_tbl_2g_pvs2_lge_factory) },
	[0][0][3] = { acpu_freq_tbl_2g_pvs3_lge_factory, sizeof(acpu_freq_tbl_2g_pvs3_lge_factory) },
	[0][0][4] = { acpu_freq_tbl_2g_pvs4_lge_factory, sizeof(acpu_freq_tbl_2g_pvs4_lge_factory) },
	[0][0][5] = { acpu_freq_tbl_2g_pvs5_lge_factory, sizeof(acpu_freq_tbl_2g_pvs5_lge_factory) },
	[0][0][6] = { acpu_freq_tbl_2g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2g_pvs6_lge_factory) },
	[0][0][7] = { acpu_freq_tbl_2g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2g_pvs6_lge_factory) },

	/* 8974v2 2.3GHz Parts */
	[0][1][0] = { acpu_freq_tbl_2p3g_pvs0_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs0_lge_factory) },
	[0][1][1] = { acpu_freq_tbl_2p3g_pvs1_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs1_lge_factory) },
	[0][1][2] = { acpu_freq_tbl_2p3g_pvs2_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs2_lge_factory) },
	[0][1][3] = { acpu_freq_tbl_2p3g_pvs3_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs3_lge_factory) },
	[0][1][4] = { acpu_freq_tbl_2p3g_pvs4_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs4_lge_factory) },
	[0][1][5] = { acpu_freq_tbl_2p3g_pvs5_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs5_lge_factory) },
	[0][1][6] = { acpu_freq_tbl_2p3g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs6_lge_factory) },
	[0][1][7] = { acpu_freq_tbl_2p3g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs6_lge_factory) },

	/* 8974v2 2.0GHz Parts */
	[0][2][0] = { acpu_freq_tbl_2p2g_pvs0_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs0_lge_factory) },
	[0][2][1] = { acpu_freq_tbl_2p2g_pvs1_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs1_lge_factory) },
	[0][2][2] = { acpu_freq_tbl_2p2g_pvs2_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs2_lge_factory) },
	[0][2][3] = { acpu_freq_tbl_2p2g_pvs3_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs3_lge_factory) },
	[0][2][4] = { acpu_freq_tbl_2p2g_pvs4_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs4_lge_factory) },
	[0][2][5] = { acpu_freq_tbl_2p2g_pvs5_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs5_lge_factory) },
	[0][2][6] = { acpu_freq_tbl_2p2g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs6_lge_factory) },
...
static int __init acpuclk_8974_probe(struct platform_device *pdev)
{
	...
	if(boot_mode == LGE_BOOT_MODE_MINIOS ||
		...
		if (SOCINFO_VERSION_MAJOR(socinfo_get_version()) == 1) {
			...
			acpuclk_8974_params_lge_factory.l2_freq_tbl = l2_freq_tbl;
			bus_scale_data.usecase = bw_level_tbl;
			bus_scale_data.num_usecases = ARRAY_SIZE(bw_level_tbl);
			acpuclk_8974_params_lge_factory.l2_freq_tbl_size = sizeof(l2_freq_tbl);
